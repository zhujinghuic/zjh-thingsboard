...
public class CrcUtils {
    ...
    public static String calcCrc16(byte[] data) {
        int DecVal = calcCrc16(data, 0, data.length);
        String hexVal = Integer.toHexString(DecVal);
        String highLowVal = hexVal.substring(2) + hexVal.substring(0, 2);
        return highLowVal;
    }
...
////        System.out.println(CrcUtils.yihuo("123456001780060B0000000000100B13812345678055"));
//        String a = "652C0050";
////        System.out.println(CrcUtils.calcCrc16(HexUtil.decodeHex(a)));
//    }
}
